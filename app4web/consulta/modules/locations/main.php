		...
		<div class="row">
			<div class="col-md-12 center" style="text-align: right;">					
				<div class="btn-group  ">
						...
						<a href="?mod=locations&proc=new" class="btn btn-medium btn-primary" title="Nueva Ubicación"><i class="fa fa-plus   hidden-lg fa fa-2x tip-bottom" data-original-title="Nuevo Artículo"></i> <span class="visible-lg" >Nueva Ubicación</span></a>
...
var table =   $('#example').dataTable( {
	...
	"aLengthMenu": [[10, 50, 100,500, -1], [10, 50, 100,500, "Todos"]],
        "sServerMethod": "POST",
        "sAjaxSource": "?mod=locations&proc=list",
 "dom": 'C<"clear">lfrtip'
...
$.post( "?mod=locations&proc=delete", inputElemsValues , function( data ) {
...
var inputElemsValues = $('[name="selected_item[]"]:checked').val();
	window.location.href = '?mod=locations&proc=edit&item_id=' + inputElemsValues;
