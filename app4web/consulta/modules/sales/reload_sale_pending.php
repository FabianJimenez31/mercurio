...
$num_tel_ok=($num_tel!='')?"<p style='color:green;'><b>OK</b></p>":"<p style='color:red;'><b>NO HA INGRESADO NUMERO DE TELEFONO</b></p>";
...
";
$temp_contrato_ok=($temp_contrato!='')?"<p style='color:green;'><b>OK</b></p>":"<p style='color:red;'><b>NO HA INGRESADO EL ARCHIVO DE CONTRATO</b></p>";
...
if($is_service==1 && $is_serialized==1){
if($i['serial']==''){$serial_ok="<p style='color:red;'><b>NO HA INGRESADO NUMERO DE CONTRATO</b></p>";}else{$serial_ok="<p style='color:green;'><b>OK</b></p>";}
}

if(($serial_ok=="<p style='color:red;'><b>SERIAL NO EXISTE</b></p>" || $serial_ok=="<p style='color:red;'><b>NO HA INGRESADO NUMERO DE CONTRATO</b></p>")  &&  $is_serialized>0){$sin_seriales++;}
