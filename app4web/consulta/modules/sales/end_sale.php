...
if($info['val_serial']==1){$k=update_mysql('inventory',$inventory,"trans_items=".$i['item_id']." AND serialNumber='".$i['serial']."'");}
}
if($info['iva']>0){
$taxes=array(
'sale_id'=>$venta['last_id'],
...
$actualiza=array('message'=>label_me('saved_info'),'message_header'=>label_me('success'),'success'=>true,'req_id'=>$venta['last_id']);
