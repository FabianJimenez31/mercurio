			...
			<div class="widget-box">
				...
				<div class="widget-content nopadding">
					...
					<label for="account_number" class="col-sm-3 col-md-3 col-lg-2 control-label required wide">Número de Documento de Identificación:</label>						<div class="col-sm-9 col-md-9 col-lg-10">
						<input type="text" name="account_number" value="" id="account_number" class="form-control form-inps"  />
<input type="hidden" name="cc_token" value="0" id="cc_token" class="form-control form-inps"  />
						</div>
					</div>
