		...
		<div class="panel">
			<div class="panel-body">
				<div class="list-group parent-list">
						...
						<a href="#" class="list-group-item" id="reimpress"><i class="fa fa-table"></i>	<?php echo label_me('configurate'); ?></a>
						<a href="#" class="list-group-item" id="boxes"><i class="fa fa-table"></i>	<?php echo label_me('generate'); ?> <?php echo label_me('csv_file'); ?></a>
		...
		<div class="panel">
			...
			<h3 class="page-header text-info"><?php echo label_me('select'); ?> <?php echo label_me('an_option'); ?></h3>
				...
				<div class="list-group reimpress hidden">
					<a href="?mod=contable&proc=config" class="list-group-item ">
						<i class="fa fa-search report-icon"></i> <?php echo label_me('config'); ?> <?php echo label_me('main'); ?> </a>

					<a href="?mod=contable&proc=config_cat" class="list-group-item ">
						<i class="fa fa-search report-icon"></i> <?php echo label_me('config'); ?> <?php echo label_me('of'); ?> <?php echo label_me('accounts'); ?> / <?php echo label_me('categories'); ?> </a>


				</div>

				<div class="list-group boxes hidden">
					<a href="?mod=contable&proc=main_conta" class="list-group-item ">
