...
$f=update_mysql('sessions',array('consignado_datafonos'=>$_POST['new_value']),'session_id='.$_POST['session_id']);
echo  "[ ".number_format($consignado,2,',','.')." ] $valido_monto <a onclick=\"javascript:delete_datafono_monto('".$_POST['container']."',".$_POST['session_id'].",'$efectivo');\">Eliminar</a>";
