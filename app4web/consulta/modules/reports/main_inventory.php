	...
	<div class="col-md-12">
		<div class="widget-box">
			<div class="widget-title">
				...
				<h5><label for="report_date_range_label">Seleccione la Fecha Deseada</label>				</h5>
			</div>
			<div class="widget-content nopadding">
					<form  class="form-horizontal form-horizontal-mobiles" action="?mod=reports&proc=inventory_report" method='POST'>
