...
?>
<li><a href="?mod=mis_ventas&proc=main"><i class="fa fa-table"></i><span class="hidden-minibar">Mis Ventas</span></a></li>
<?php

}
foreach($modulos['result'] as $m){
if($m['module_id']!='receivings' && $m['module_id']!='working_hours' && $m['module_id']!='recepcion_turnos' && $m['module_id']!='giftcards'  && $m['module_id']!='manual_sales' && $m['module_id']!='mis_ventas' && $m['module_id']!='supervisores' && $m['module_id']!='item_kits'){
...
<li><a href="?mod=home&proc=logout"><i class="fa fa-power-off"></i><span class="hidden-minibar">Salir</span></a></li>
                    </li>
                </ul>
            </div>
