...
<form action="?mod=locations&proc=save" method="post" accept-charset="utf-8" id="item_form" class="form-horizontal">
			...
			<div class="widget-box">
				...
				<div class="widget-content nopadding">
					...
					<label for="address" class="col-sm-3 col-md-3 col-lg-2 control-label required wide">Dirección:</label>						<div class="col-sm-9 col-md-9 col-lg-10">
						<textarea name="address" cols="17" rows="5" id="address" class="form-control  form-textarea" ></textarea>						</div>
					</div>
