...
$show_header=($application_config['config_invoice_show_header']=="YES")?"":" display:none;";
...
?>
                                                        ...
                                                        <div> <p class="text-left" style="<?php echo $show_header; ?>">RÉGIMEN COMÚN</br></p></div>
                        </div>           
                    </div>                
                </div>
                <!--Resolucion Facturacion-->
                <div class="col-xs-6" style="font-size: 7px; <?php echo $show_header; ?>">
                    <div class="item">
                        <div class="content">
                            </br>
...
</br><p class="text-muted text-center"><?php echo $application_config['config_invoice_second_title'];?> </p>
				    				<br/><br/>
                    ...
                    <div class="item">
                        <div class="col-xs-6">
                            <div class="content">   
                                ...
                                <p class="text-left" style="color:red;font-weight:bold;font-size:small;"> Tu Descuento fue de: </p>
                        ...
                        <div class="col-xs-6">
                            <div class="content">   
                                ...
                                <p class="text-right" style="color:red;font-weight:bold;font-size:small;" > $<?php echo number_format($discount,2,',','.'); ?> </p>
