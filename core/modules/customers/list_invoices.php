...
if(permitido($user_array['person_id'],$_GET['mod'])){	/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
	 ...
	 */
$aColumns = array( 'fecha' , 'sale_id', 'vendedor');
...
t1.sale_time as fecha,
concat(t2.first_name , ' ' , t2.last_name) as vendedor,
t1.sale_id as sale_id
from


".DBPREFIX."sales AS t1 

INNER JOIN ".DBPREFIX."people AS t2 ON t1.salesman = t2.person_id

where t1.customer_id = ".$_GET['uid']."
...
//	include( $_SERVER['DOCUMENT_ROOT']."/datatables/mysql.php" );
	...
	while ( $aRow = mysqli_fetch_array( $rResult ) )
	{
		...
		$row[] = "<a href=\"?mod=receipts&proc=sales&id=".$aRow['sale_id']."\" target=_blank >Re-Imprimir</a>";
		$output['aaData'][] = $row;
