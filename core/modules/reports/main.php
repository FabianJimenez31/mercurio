			...
			<h3 class="page-header text-info">Seleccione un Reporte</h3>
				...
				<div class="list-group reimpress hidden">
					<a href="?mod=reports&proc=main_sales" class="list-group-item ">
						<i class="fa fa-calendar report-icon"></i> Buscar por Fecha</a>

					<a href="?mod=reports&proc=main_sales_folio" class="list-group-item ">
						<i class="fa fa-search report-icon"></i> Buscar por Folio Interno</a>
