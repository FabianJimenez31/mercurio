...
<h3 class="page-header text-info">Reporte de Cierre General de Cajas del <?php echo ((isset($_POST['finicio'])) ? $_POST['finicio'] : $_GET['finicio']);?> al <?php echo ((isset($_POST['ffinal'])) ? $_POST['ffinal'] : $_GET['ffinal']);?></h3>
...
$sessions=select_mysql("*",'sessions',"date_start>='$finicio' and date_start<='$ffinal' and is_general=1");
