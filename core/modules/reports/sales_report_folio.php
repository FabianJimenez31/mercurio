...
<h3 class="page-header text-info">Reporte de Facturas [ '<?php echo $_POST['folio']; ?>' ]</h3>
...
<?php
$sales=select_mysql("*",'sales',"sale_id like '".$_POST['folio']."'");
if($sales['count']<=0){
$sales=select_mysql("*",'sales',"sale_id like '".($_POST['folio']+1)."'");
}

if($sales['count']<=0){
$sales=select_mysql("*",'sales',"sale_id like '".($_POST['folio']+2)."'");
}


if($sales['count']<=0){
$sales=select_mysql("*",'sales',"sale_id like '".($_POST['folio']+3)."'");
}

if($sales['count']<=0){
$sales=select_mysql("*",'sales',"sale_id like '".($_POST['folio']+4)."'");
}

if($sales['count']<=0){
$sales=select_mysql("*",'sales',"sale_id like '".($_POST['folio']+5)."'");
}
