...
if($user_array['profile']!=2 && $user_array['person_id']>0){
load_template('partial','header');
load_template('partial','menu');

$usuario=select_mysql("*","users","id='".$user_array['id']."'");



?>

<div data-role="header" data-theme="a">Bienvenido <?php echo $usuario['result'][0]['first_name'] ?></div>

			<!--	<a href="?mod=sales&proc=main" class="ui-btn" data-ajax="false">Nueva Venta</a>
				<a href="?mod=stock&proc=main" class="ui-btn" data-ajax="false">Revisar Stock</a>
				<a href="?mod=recov_sales&proc=main" class="ui-btn" data-ajax="false">Recuperar Venta No Enviada</a>-->
...
}elseif($user_id=='offlineuser'){
load_process('preventa','main');
}else{

load_process('seguimiento','main');
