...
$discount_field="<table><tr><td>".number_format($discount,2)."</td><td>%</td></tr></table>";
...
log_me(grab_dump($current_sale_array));
...
$num_tel_ok=($num_tel!='')?"<p style='color:green;'><b>OK</b></p>":"<p style='color:red;'><b>SUBE EL NUMERO DEL LISIM</b></p>";
...
<a onclick=\"javascript:upload_image_contrato('$k');\">Subir Archivo</a>
</form>
</div>
";
$temp_contrato_ok=($temp_contrato!='')?"<p style='color:green;'><b>OK</b></p>":"<p style='color:red;'><b>NO HAZ SUBIDO EL NUMERO DE LISIM</b></p>";
...
if($is_service==1 && $is_serialized==1){
if($i['serial']==''){$serial_ok="<p style='color:red;'><b>INGRESA EL NUMERO DE VALIDACION DE LISIM</b></p>";}else{$serial_ok="<p style='color:green;'><b>OK</b></p>";}
}

if(($serial_ok=="<p style='color:red;'><b>SERIAL NO EXISTE</b></p>" || $serial_ok=="<p style='color:red;'><b>INGRESA EL NUMERO DE PEDIDO DE SIEBEL</b></p>")  &&  $is_serialized>0){$sin_seriales++;}


$total=$quantity*$cost*(1-($discount/100));
$total="INLCUIDO EN KIT ";
...
$num_tel=(isset($i['num_tel']) && $i['num_tel']!='') ? $i['num_tel'] : '';
$num_tel_field="<input type='text' value='".$num_tel."' onchange=\"javascript:change_numtel('$k',this.value);\">";
$num_tel_ok=($num_tel!='')?"<p style='color:green;'><b>OK</b></p>":"<p style='color:red;'><b>INGRESA EL NUMERO DE CELULAR ASIGNADO AL USUARIO</b></p>";
...
";
$temp_contrato_ok=($temp_contrato!='')?"<p style='color:green;'><b>OK</b></p>":"<p style='color:red;'><b>NO HAZ SUBIDO EL ARCHIVO DE LISIM</b></p>";
...
if($is_service==1 && $is_serialized==1){
if($i['serial']==''){$serial_ok="<p style='color:red;'><b>NO HAZ EL ARCHIVO DE LISIM</b></p>";}else{$serial_ok="<p style='color:green;'><b>OK</b></p>";}
}
