...
$items=select_mysql("*","requisitions_items","quantity_accepts is not null and requisitionId=".$_GET['req_id']);
...
function eliminar_serial( id_serial , t_item){
var continuar = confirm("¿Está seguro de continuar con la acción de eliminar el serial?");
if(continuar){

$.post("?mod=entries&proc=delete_item", { serial_id : id_serial , ver_trans : "<?php echo $_GET['req_id']; ?>" , requisition_id: "<?php echo $_GET['req_id']; ?>" , item_id: t_item} , function(data){
