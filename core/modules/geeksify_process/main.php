...
var table =   $('#example').dataTable( {
	...
	"aLengthMenu": [[10, 50, 100,500, -1], [10, 50, 100,500, "Todos"]],
        "sServerMethod": "POST",
        "sAjaxSource": "?mod=geeksify_process&proc=list",
 "dom": 'C<"clear">lfrtip'
...
$.post( "?mod=entries&proc=delete", inputElemsValues , function( data ) {
...
var inputElemsValues = $('[name="selected_item[]"]:checked').val();
	window.location.href = '?mod=entries&proc=edit&person_id=' + inputElemsValues;
