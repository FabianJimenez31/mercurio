...
if(permitido($user_array['person_id'],$_GET['mod'])){	/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
	 ...
	 */
$aColumns = array( 'fecha' , 'usuario', 'ip_consulta','modulo_c' , 'proceso_c' , 'poste' , 'geto');
...
t1.horafecha as fecha,
CONCAT(t2.first_name, ' ' , t2.last_name) as usuario,
t1.ip_acceso as ip_consulta,
t1.modulo as modulo_c,
t1.proceso as proceso_c,
t1.post_variables as poste,
t1.get_variables as geto

from


".DBPREFIX."logger AS t1 

INNER JOIN ".DBPREFIX."people AS t2 ON t1.usuario_id = t2.person_id
