		...
		<div class="row">
			<div class="col-md-12 center" style="text-align: right;">					
				<div class="btn-group  ">
						...
						<a href="?mod=comisiones&proc=new_metas" class="btn btn-medium btn-primary" title="Nuevo Rango"><i class="fa fa-plus   hidden-lg fa fa-2x tip-bottom" data-original-title="Nuevo Artículo"></i> <span class="visible-lg" >Nuevo Esquema de Metas</span></a>
...
var table =   $('#example').DataTable( {
        "ajax": "?mod=comisiones&proc=list_metas"	
    } );
...
$.post( "?mod=comisiones&proc=delete_metas", inputElemsValues , function( data ) {
...
var inputElemsValues = $('[name="selected_item[]"]:checked').val();
	window.location.href = '?mod=comisiones&proc=edit_metas&item_id=' + inputElemsValues;
