		...
		<div class="row">
			<div class="col-md-12 center" style="text-align: right;">					
				<div class="btn-group  ">
						...
						<a href="?mod=comisiones&proc=new_rangos" class="btn btn-medium btn-primary" title="Nuevo Rango"><i class="fa fa-plus   hidden-lg fa fa-2x tip-bottom" data-original-title="Nuevo Artículo"></i> <span class="visible-lg" >Nuevo Rango</span></a>
...
var table =   $('#example').DataTable( {
        "ajax": "?mod=comisiones&proc=list_rangos"	
    } );
...
$.post( "?mod=comisiones&proc=delete_rangos", inputElemsValues , function( data ) {
...
var inputElemsValues = $('[name="selected_item[]"]:checked').val();
	window.location.href = '?mod=comisiones&proc=edit_rangos&item_id=' + inputElemsValues;
