		...
		<div class="row">
			<div class="col-md-12 center" style="text-align: right;">					
				<div class="btn-group  ">
						...
						<a href="?mod=comisiones&proc=new_cat" class="btn btn-medium btn-primary" title="Nuevo Artículo"><i class="fa fa-plus   hidden-lg fa fa-2x tip-bottom" data-original-title="Nuevo Artículo"></i> <span class="visible-lg" >Nueva Categoria</span></a>
...
var table =   $('#example').DataTable( {
        "ajax": "?mod=comisiones&proc=list_cat"	
    } );
...
$.post( "?mod=comisiones&proc=delete_cat", inputElemsValues , function( data ) {
...
var inputElemsValues = $('[name="selected_item[]"]:checked').val();
	window.location.href = '?mod=comisiones&proc=edit_cat&item_id=' + inputElemsValues;
