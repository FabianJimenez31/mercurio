...
<form action="?mod=comisiones&proc=save_rangos" method="post" accept-charset="utf-8" id="item_form" class="form-horizontal">
				...
				<div class="widget-content nopadding">
					...
					<div class="form-group">
						<label for="maximo" class="col-sm-3 col-md-3 col-lg-2 control-label  wide">Menos de:</label>						<div class="col-sm-9 col-md-9 col-lg-10">
							...
							<input type="number" name="maximo" value="" id="maximo" class="form-control form-inps"  />
