...
$inf=select_mysql("*","rangos","id=".$_GET['item_id']);
$info=$inf['result'][0];
?>


<form action="?mod=comisiones&proc=save_rangos&item_id=<?php echo $_GET['item_id']?>" method="post" accept-charset="utf-8" id="item_form" class="form-horizontal">
		...
		<div class="col-md-12">
			...
			<div class="widget-box">
				...
				<div class="widget-content nopadding">
					...
					<div class="form-group">
						<label for="maximo" class="col-sm-3 col-md-3 col-lg-2 control-label  wide">Menos de:</label>						<div class="col-sm-9 col-md-9 col-lg-10">
							<div class="input-group">
							<input type="number" name="maximo" value="<?php echo $info['maximo'] ?>" id="maximio" class="form-control form-inps"  />
								<div class="input-group-addon">%</div>
    							</div> '0' (cero) es equivalente a "En Adelante"
 						</div>
					</div>
