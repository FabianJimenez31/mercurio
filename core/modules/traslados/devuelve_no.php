...
update_mysql("traslados_items",array('regresado'=>'0','cancelacion'=>''),'tx_id='.$_GET['tx_id']);
...
Operación: Cancelación de Devolución de Artículo de la Órden de Traslado con ID Interno ".$traslado_id."
