...
       <tr>
	{[date_th]}
         <th data-priority="2">Vendedor</th>
...
<td>{[ser:ventas]}</td>
<td>
<a href="#{[ser:unico]}" data-rel="popup" class="ui-btn ui-corner-all ui-shadow ui-btn-inline">{[ser:articulos]}</a>
<div data-role="popup" id="{[ser:unico]}" class="ui-content" style="max-width:280px">
