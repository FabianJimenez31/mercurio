...
       <li data-icon="cloud"><a data-rel="close" href="#main_content" onclick="javascript:load_page('admin_portal','servers');">Actualizar</a></li>
       <li data-icon="grid"><a data-rel="close" href="#main_content" onclick="javascript:load_page('admin_portal','clients');">Tiendas</a></li>
       <li data-icon="tag"><a data-rel="close" href="#main_content" onclick="javascript:load_page('admin_portal','items');">Inventario Global</a></li>
       <li data-icon="bullets"><a data-rel="close" href="#main_content" onclick="javascript:load_page('reports','main');">Reportes</a></li>
       <li data-icon="bullets"><a data-rel="close" href="#main_content" onclick="javascript:load_page('reports','cajas');">Historial Cajas</a></li>
       <li data-icon="action"><a data-rel="close" href="#main_content" onclick="javascript:load_page('reports','tableau');">Tableau Query</a></li>
...
     <ul data-role="listview" >
       <li data-icon="cloud"><a href="#main_content" onclick="javascript:load_page('admin_portal','servers');">Actualizar</a></li>
       <li data-icon="grid"><a href="#main_content" onclick="javascript:load_page('admin_portal','clients');">Tiendas</a></li>
       <li data-icon="tag"><a data-rel="close" href="#main_content" onclick="javascript:load_page('admin_portal','items');">Inventario Global</a></li>
 <li data-icon="bullets"><a data-rel="close" href="#main_content" onclick="javascript:load_page('reports','main');">Reportes</a></li>
 <li data-icon="bullets"><a data-rel="close" href="#main_content" onclick="javascript:load_page('reports','cajas');">Historial Cajas</a></li>
 <li data-icon="action"><a data-rel="close" href="#main_content" onclick="javascript:load_page('reports','tableau');">Tableau Query</a></li>
